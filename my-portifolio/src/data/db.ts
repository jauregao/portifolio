export const pt = {
    ...
    social: [
        ...
        infos: {
        about: "Sou desenvolvedora backend e estudante de Matemática na UFF. Tenho experiência com Node.js, TypeScript, NestJS, PostgreSQL, MongoDB e AWS, focando na construção de APIs seguras e escaláveis. Atualmente, estou me aprofundando em microsserviços e cloud computing./ Atualmente, trabalho com educação em tecnologia como monitora Fullstack, auxiliando alunos no aprendizado, resolução de bugs e boas práticas de desenvolvimento. Além disso, faço freelancers com WordPress, Elementor e WooCommerce, cuidando de hospedagens compartilhadas, VPS, DNS, bancos de dados e integrações com API's externas. Também comecei a explorar o frontend para ampliar meu repertório e entender melhor o outro lado do desenvolvimento./ Minha experiência anterior na educação como monitora de design gráfico me trouxe habilidades valiosas em comunicação, organização e resolução de problemas, que aplico diariamente para estruturar soluções eficientes e bem planejadas./  Estou sempre buscando novos desafios e projetos que me façam evoluir.",
        techIcons: [
            { 
                name: "Docker",
