export const pt = {
    ...
    social: [
        ...
        infos: {
        about: "Sou desenvolvedora backend e estudante de Licenciatura em Matemática na UFF e de Análise e Desenvolvimento de Sistemas na UNICSUL. Tenho experiência com Node.js, TypeScript, NestJS, PostgreSQL, MongoDB e AWS, com foco na construção de APIs seguras e escaláveis. No momento, estou me aprofundando em microsserviços e cloud computing./Atualmente, trabalho com educação em tecnologia como monitora Fullstack, auxiliando alunos no aprendizado, resolução de bugs e boas práticas de desenvolvimento. Também realizo freelancers com WordPress, Elementor e WooCommerce, cuidando de hospedagens, VPS, DNS, bancos de dados e integrações com APIs externas. Paralelamente, venho explorando o frontend com React e Next.js para ampliar meu repertório e compreender melhor todo o ciclo do desenvolvimento web./Minha trajetória começou como monitora de design gráfico e estagiária em desenvolvimento web com WordPress, experiências que fortaleceram minha comunicação, organização e capacidade de resolver problemas técnicos de forma eficiente./Estou sempre em busca de novos desafios e projetos que contribuam para minha evolução profissional.",
        techIcons: [
            { 
                name: "Docker",
