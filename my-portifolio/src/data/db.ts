export const pt = {
    ...
    social: [
        ...
        infos: {
        about: "Antes de entrar na área de tecnologia, cursei parte do curso de Licenciatura em Química na UFF e trabalhei na área da educação. Essa experiência me trouxe habilidades valiosas em comunicação, resolução de problemas e trabalho em equipe, refletindo minha vontade de enfrentar novos desafios. Como eterna estudante, sempre busco desafios que me permitam aplicar minha paixão pela tecnologia./ No desenvolvimento BackEnd, me sinto confortável com JavaScript, TypeScript, NodeJS e Express, e exploro bancos de dados como MySQL, PostgreSQL e MongoDB. Além disso, estou começando no FrontEnd para expandir meu repertório. Meu próximo passo? Mergulhar em microsserviços e cloud computing, abrindo portas para desafios ainda maiores na minha carreira. Com uma mentalidade proativa e resiliente, estou determinada a deixar minha marca como uma mente criativa e inovadora.",
        techIcons: [
            { 
                name: "Docker",
